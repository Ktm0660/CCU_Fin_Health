...
export default function ToolsPage() {
  ...
  return <section className="py-6">
    <div className="rounded-3xl border bg-white p-5 shadow md:p-7">
      ...
      <p className="mt-3 text-slate-700">{T("Use these tools to turn your plan into a concrete next step. You are in control of what you share.", "Usa estas herramientas para convertir tu plan en un próximo paso concreto. Tú controlas lo que compartes.")}</p>
